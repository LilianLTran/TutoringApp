          ...
          <tbody className="divide-y divide-gray-100">
            {sorted.map((c) => (
              <tr key={c.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-5 py-3 text-center">{c._count.requests}</td>
                <td className="px-5 py-3 text-center">{c._count.sessions}</td>
                <td className="px-5 py-3 text-center">{c._count.tutors}</td>
                <td className="px-5 py-3 text-center">{c._count.instructors}</td>
          ...
          <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-lg">
            ...
            <div className="mt-3 rounded-lg border bg-gray-50 p-3 text-xs text-gray-600">
              ...
              <ul className="mt-2 list-disc pl-5 space-y-1">
                ...
                <li>and unlink {toDelete._count.tutors} tutor(s) + {toDelete._count.instructors} instructor(s)</li>
              </ul>
            </div>
